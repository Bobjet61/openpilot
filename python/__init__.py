...
class Panda:
  ...
  FLAG_CHRYSLER_JEEP_LONG_SHADOW = 4
  FLAG_CHRYSLER_JEEP_RATE4 = 8
  FLAG_CHRYSLER_JEEP_LONG_DIAGNOSTIC = 16
  FLAG_CHRYSLER_JEEP_RATE5 = 32
  FLAG_CHRYSLER_JEEP_LONG_ACTUATION = 64
  FLAG_CHRYSLER_JEEP_FACTORY_SNG = 128
